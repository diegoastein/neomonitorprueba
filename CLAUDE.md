...
- **v1.06**: Fixed false "disconnect" banner on Control when idle. Watchdog now resets on **write operations** (heartbeat), not just on listener data changes. Control idle for 30s → no false positive ✓
